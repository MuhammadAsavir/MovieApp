...
const APILINK = 'https://1536b26b-e895-41a3-889c-589713892be5-00-33ikwryslkb95.pike.replit.dev/api/v1/reviews/';
...
function returnReviews(url){
  ...
  data.forEach(review => {
      ...
      div_card.innerHTML = `
          <div class="row">
            <div class="column">
              <div class="card reviewCard" id="${review._id}" style="height:auto;">
